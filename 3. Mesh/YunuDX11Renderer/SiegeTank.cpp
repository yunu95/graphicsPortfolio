...
SiegeTank::SiegeTank(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, ID3D11RasterizerState* pRS)
...
void SiegeTank::Update(Camera* pCamera)
{
...
void SiegeTank::BuildGeometryBuffers()
{
