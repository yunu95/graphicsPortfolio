...
DebugSphere::DebugSphere(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, ID3D11RasterizerState* pRS)
...
void DebugSphere::Initialize()
{
    ...
    HR(CreateDDSTextureFromFile(md3dDevice,
        L"Textures/WoodDebugSphere01.dds", &texResource, &mDiffuseMapSRV));
    texResource->Release();	// view saves reference

    BuildGeometryBuffers();
}

void DebugSphere::Update(Camera* pCamera, float deltaTime)
{
...
void DebugSphere::BuildGeometryBuffers()
{
